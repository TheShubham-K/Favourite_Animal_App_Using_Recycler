...
public class MainActivity extends AppCompatActivity implements AnimalAdapter.MyClickInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animals.add(new Animal("Kiwi",R.drawable.kiwi));
        animals.add(new Animal("Owl",R.drawable.owl));
        animals.add(new Animal("Pug",R.drawable.pug));
        animals.add(new Animal("Rain Deer",R.drawable.rain_deer));
        animals.add(new Animal("Snow Wolf",R.drawable.snow_wolf));
        animals.add(new Animal("Squirrel",R.drawable.squirral));
...
//        Toast.makeText(this, "Clicked "+animals.get(positionOfTheAnimal).getName(), Toast.LENGTH_SHORT).show();
        ...
        intent.putExtra("name",animals.get(positionOfTheAnimal).getImage());
